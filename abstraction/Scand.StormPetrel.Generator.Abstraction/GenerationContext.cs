...
namespace Scand.StormPetrel.Generator.Abstraction
{
    ...
    public sealed class GenerationContext
    {
        ...
        public string[] ActualVariablePath { get; set; } = Array.Empty<string>();
        /// <summary>
        /// Expected variable value.
        /// </summary>
        public object? Expected { get; set; }
        public string[] ExpectedVariablePath { get; set; } = Array.Empty<string>();
        /// <summary>
        ...
        /// </summary>
        public MethodContext MethodSharedContext { get; set; } = new MethodContext();
    }
}
