        ...
        private const string List2ElementsMultiline = @"new List<string>()
{
    ...
    ""2""
        ...
        [InlineData("090_ExpressionRewriter", new[] { "Foo", "Bla[1]" }, SyntaxKind.LocalDeclarationStatement, 0, EmptyList, "090_ExpressionRewriter_NewCode_MethodOverload1_Then_Expected")]
