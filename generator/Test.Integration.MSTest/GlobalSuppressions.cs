...
[assembly: SuppressMessage("Maintainability", "CA1508:Avoid dead conditional code", Justification = "To intentionally test the use case", Scope = "member", Target = "~M:Test.Integration.MSTest.NoExpectedVarWithOperatorsTest.WhenNullCoalescingOperatorTest")]
[assembly: SuppressMessage("Usage", "MSTEST0037:Use proper 'Assert' methods", Justification = "To intentionally test the use case", Scope = "member", Target = "~M:Test.Integration.MSTest.NoExpectedVarWithOperatorsTest.WhenNullConditionalOperatorAssertsNullTest")]
