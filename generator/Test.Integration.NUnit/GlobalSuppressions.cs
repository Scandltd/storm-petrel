...
[assembly: SuppressMessage("Assertion", "NUnit2045:Use Assert.Multiple", Justification = "To intentionally test the use case", Scope = "member", Target = "~M:Test.Integration.NUnit.NoExpectedVarAssertThatTest.AssertThatEqualConstraintTest")]
[assembly: SuppressMessage("Assertion", "NUnit2045:Use Assert.Multiple", Justification = "To intentionally test the use case", Scope = "member", Target = "~M:Test.Integration.NUnit.NoExpectedVarWithOperatorsTest.WhenNullConditionalOperatorTest")]
[assembly: SuppressMessage("Assertion", "NUnit2045:Use Assert.Multiple", Justification = "To intentionally test the use case", Scope = "member", Target = "~M:Test.Integration.NUnit.NoExpectedVarWithOperatorsTest.WhenNullConditionalOperatorAssertsNullTest")]
[assembly: SuppressMessage("Assertion", "NUnit2045:Use Assert.Multiple", Justification = "To intentionally test the use case", Scope = "member", Target = "~M:Test.Integration.NUnit.NoExpectedVarWithOperatorsTest.WhenNullForgivenOperatorTest")]
[assembly: SuppressMessage("Maintainability", "CA1508:Avoid dead conditional code", Justification = "To intentionally test the use case", Scope = "member", Target = "~M:Test.Integration.NUnit.NoExpectedVarWithOperatorsTest.WhenNullCoalescingOperatorTest")]
[assembly: SuppressMessage("Assertion", "NUnit2045:Use Assert.Multiple", Justification = "To intentionally test the use case", Scope = "member", Target = "~M:Test.Integration.NUnit.NoExpectedVarWithOperatorsTest.WhenNullCoalescingOperatorTest")]
