...
public sealed class PerformanceTestsGenerator
{
    ...
    private static void GenerateExpectedInlineInstance(int classesCount = 5, int methodsInClassCount = 10)
    {
...
@$"
    ...
    private static void GenerateExpectedInMethod(int classesCount = 5, int methodsInClassCount = 10)
    {
        string classTemplate =
@$"{GetAutoGeneratedPreamble()}
using FluentAssertions;
